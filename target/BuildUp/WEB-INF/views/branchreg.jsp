...
<c:if test="${!checkk  && sessionScope.Administrator}">
    <div align="center">
        <sf:form role="form" action="addBranch" method="post" commandName="branch" modelAttribute="branch"  enctype="multipart/form-data" class="form-control input-lg">
            <table border="0" >
                <tr>
                    <td colspan="2" align="center">
                    <h2>Branch Details</h2></td>
               
                <tr>
                    <td>Branch</td>
                    <td><sf:input type="text" path="bname" required="true"/></td>
                </tr>
                
                <tr>
                 <td> <sf:label path="fname">Field</sf:label></td>
                 <td> <sf:select path="fname" class="form-control input-sm">
                ...
                <tr>
                    <td>Image</td>
                    <td><sf:input path="bimage" type="file" required="true"/></td>
                </tr>
                <tr>
                    <td colspan="2" align="center"><input type="submit" value="Add Branch" /></td>
                </tr>
            </table>
        </sf:form>
