...
<c:if test="${!checkk && sessionScope.Administrator}">
    <div align="center">
        <sf:form action="addDomain" method="post" commandName="domain" enctype="multipart/form-data" class="form-control input-lg">
            <table border="0" >
                <tr>
                    <td colspan="2" align="center">
                    <h2>Domain Details</h2></td>
                    </tr>
                      <tr>
                    <td>Domain</td>
                    <td><sf:input type="text" path="dname" required="true"/></td>
                </tr>
                  <tr>
                    <td><sf:label path="fname" >Field</sf:label></td>
                    <td> <sf:select path="fname" class="form-control input-sm" ng-model="field">
                          <sf:option value=""  >--Select--</sf:option>
                         <sf:option ng-repeat="fields in mylist2" value="{{fields.fname}}">{{fields.fname}}</sf:option>
                         </sf:select></td>
                </tr>
                <tr>
                    <td><sf:label path="bname" >Branch</sf:label></td>
                    <td> <sf:select path="bname" class="form-control input-sm" >
                         <sf:option value="" >--Select--</sf:option>
                         <sf:option ng-repeat="fields in mylist1|filter:{fname:field}" value="{{fields.bname}}">{{fields.bname}}</sf:option>
                         </sf:select></td>
                </tr>
                <tr>
                    <td>Price for Interview</td>
                    <td><sf:input type="text" path="price" required="true" /></td>
                </tr>
                <tr>
                    <td>Description</td>
                ...
                <tr>
                    <td>Image</td>
                    <td><sf:input path="dimage" type="file" required="true"/></td>
                </tr>
                <tr>
                    <td colspan="2" align="center"><input type="submit" value="Add Domain" /></td>
                </tr>
            </table>
        </sf:form>
    </div>
