...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<sf:form role="form"  action="addField" commandName="field" method="post" enctype="multipart/form-data">
			<h2>FIELD DETAILS</h2>
			<hr class="colorgraph">
					...
					<div class="col-xs-12"><input type="submit" value="Add-Field" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
					</div>
				</div>
